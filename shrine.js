...
function emination(count) {
    ...
    //jackal eyes
     if (jackals) {
         ...
         drawArkInstructionCuneiform(jackalCenterX - jackal.width * .25, arkInstructionY, RIGHT)
         drawArkInstructionCuneiform(jackalCenterX + jackal.width * .25, arkInstructionY, LEFT)
         pop()
